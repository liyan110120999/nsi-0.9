...
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
    ...
    <link href="/nsi-0.9/assets/css/pagination.css" rel="stylesheet" />
    <!--     	自定义css -->
    <link href="/nsi-0.9/assets/css/MyCss.css" rel="stylesheet" />
    
    <script src="/nsi-0.9/assets/js/jquery-1.11.1.js"></script>
    <!-- BOOTSTRAP SCRIPTS  -->
    <script src="/nsi-0.9/assets/js/bootstrap.js"></script>
    <!-- CUSTOM SCRIPTS  -->
    <script src="/nsi-0.9/assets/js/custom.js"></script>
    
    <script src="/nsi-0.9/assets/js/jquery.pagination.js"></script>
...
<!-- 	分页配置 -->
	 ...
	 // 点击分页按钮以后触发的动作
		function handlePaginationClick(new_page_index, pagination_container) {
		    $("#searchForm").attr("action", "/nsi-0.9/People_servlet?pageNum=" + (new_page_index+1));
		    $("#searchForm").submit();
		    return false;
		}
		$(function(){
...
<nav class="navbar navbar-fixed-top my-navbar" role="navigation">  
	        <div class="container-fluid">  
	            <div class="navbar-header l-h-001">  
	                ...
	                <div>
	               	 	<img src="/nsi-0.9/assets/img/logo.png" class="img-rounded" width="250" height="60">
	                </div>
	            </div>  
	            <div class="collapse navbar-collapse l-f20" id="example-navbar-collapse">  
	                <ul class="nav navbar-nav navbar-right l-h-002">  
		                <li style="margin-top:5px;"><a href="/nsi-0.9/list.jsp"><b>学 校</b></a></li>
	                    <li style="margin-top:5px;"><a href="/nsi-0.9/institution/Institution_list.jsp"><b>机 构</b></a></li>
	                   	<li style="margin-top:5px;"><a href="#"><b>人 员</b></a></li>
	                    <li style="margin-top:5px;"><a href="/nsi-0.9/about.jsp"><b>关 于</b></a></li>
	                    <li style="margin-top:5px;"><a href="/nsi-0.9/login.jsp" ><b>登 录</b></a></li>	          
	                </ul>  
	            </div>  
	        </div>  
	    </nav>  
		...
		<div class="carousel slide" id="carousel-466145">
				...
				<div class="carousel-inner">
					<div class="item">
						<img alt="" src="/nsi-0.9/assets/img/banner01.jpg" />
...
<!-- 						</div> -->
					...
					<div class="item active">
						<img alt="" src="/nsi-0.9/assets/img/banner02.jpg" />
<!-- 						<div class="carousel-caption"> -->
<!-- 							<h3> -->
<!-- 								新学说 人员数据库 -->
<!-- 							</h3> -->
...
<!-- 						</div> -->
					...
					<div class="item">
						<img alt="" src="/nsi-0.9/assets/img/banner03.jpg" />
<!-- 						<div class="carousel-caption"> -->
<!-- 							<h3> -->
<!-- 								新学说 机构数据库 -->
<!-- 							</h3> -->
		...
		<div class="col-md-12 column">
			<nav class="navbar navbar-default" role="navigation">
				<div class="navbar-header">
					 <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1"> <span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button> <a class="navbar-brand" href="#">新学说</a>
				</div>
				
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						<li>
							 <a href="/nsi-0.9/people/People_insert.jsp">新增</a>				 
						</li>
						<li>
							 <a href="#">菜单</a>				 
						</li>
					...
					<form class="navbar-form navbar-left" id="searchForm" role="search" action="/nsi-0.9/People_servlet" name="P_Searchform" method="post">
...
<div class="container-fluid">
	<div class="row clearfix">
		...
		<tbody>
			<%	for(People_model people : list){ %>
			<tr class="info">
				<td><a href="javascript:void(0)" onclick="formDetail(<%=people.getPeople_id()%>)"><%=people.getPeople_name()%></a></td>
					<form id="<%=people.getPeople_id()%>" role="form" action="People_servlet" method="post">						
						<input type="hidden" name="detail_people_id" value="<%=people.getPeople_id()%>">
						<input type="hidden" name="whereFrom" value="detail">																						
					</form>
				<td><%=people.getPeople_work()%></td>
				<td><%=people.getPeople_position()%></td>
				<td><%=people.getPeople_phone()%></td>
				<td><%=people.getPeople_mail()%></td>
				<td><%=people.getPeople_wechat()%></td>
				<td width="50px"><%=people.getPeople_loadPeople()%></td>
				<td><%=people.getPeople_loadTime()%></td>
			</tr>							
<!-- 			遍历列表 -->
		<%}%>
		</tbody>
