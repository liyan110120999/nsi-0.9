...
<head>
		...
		<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
		   ...
		   <script src="/nsi-0.9/assets/js/user.js"></script>
...
<script type="text/javascript">
	...
	function checkUserid(){  
	    ...
	    var msg ="   <img src='/nsi-0.9/assets/img/true.jpg' style='width:27px'>";  
	    if(!userid)  
	        ...
	        <div class="container-fluid">  
	            ...
	            <div class="collapse navbar-collapse" id="example-navbar-collapse">  
	                <ul class="nav navbar-nav navbar-right">  
	                    ...
	                    <li><a href="/nsi-0.9/institution/Institution_list.jsp"><b>机 构</b></a></li>
	                   	<li><a href="/nsi-0.9/people/People_list.jsp"><b>人 员</b></a></li>
	                    <li><a href="/nsi-0.9/about.jsp"><b>关 于</b></a></li>
	                    <li><a href="/nsi-0.9/login.jsp" class="active-menu-item"><b>登 录</b></a></li>
		                <li></li>
	                </ul>  
	            </div>  
	        </div>  
 ...
 <div class="container">
	<div class="row clearfix">
		<div class="col-md-12 column">
			...
			<form class="form-horizontal" role="form" action="/nsi-0.9/People_servlet" name="myform" method="post" >
